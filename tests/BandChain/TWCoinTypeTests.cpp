...
TEST(TWBandChainCoinType, TWCoinType) {
    ...
    assertStringsEqual(txUrl, "https://scan-master.bandprotocol.com//tx/473264551D3063A9EC64EC251C61BE92DDDFCF6CC46D026D1E574D83D5447173");
    assertStringsEqual(accUrl, "https://scan-master.bandprotocol.com//account/band12nmsm9khdsv0tywge43q3zwj8kkj3hvup9rltp");
    assertStringsEqual(id, "bandchain");
